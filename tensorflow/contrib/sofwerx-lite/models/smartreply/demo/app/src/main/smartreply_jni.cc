...
Java_com_sofwerx_android_smartreply_SmartReplyClient_loadJNI(
...
Java_com_sofwerx_android_smartreply_SmartReplyClient_predictJNI(
  ...
  jclass smart_reply_class = CheckNotNull(
      env, env->FindClass("com.sofwerx/android/smartreply/SmartReply"));
...
Java_com_sofwerx_android_smartreply_SmartReplyClient_unloadJNI(
